...
The SDK adapter owns retries of the same request within its single configured retry budget, honors valid `Retry-After` delays, and suppresses retries for known exhausted-quota responses.
