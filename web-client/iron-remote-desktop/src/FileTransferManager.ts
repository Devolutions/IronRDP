                    ...
                    fileSignal.addEventListener(
                        ...
                        () => {
                            ...
                            if (this.uploadState.completedFiles.size >= this.uploadState.expectedFileCount) {
                                // Retain file handles so repaste can rebuild uploadState.
                                // The DroppedFile data is still valid even though no
                                // FileContentsRequest was served for this batch.
                                this.retainedFiles = this.uploadState.droppedFiles;
                                this.uploadState = undefined;
                                this.onUploadFinished?.();
                                wrappedResolve();
                            }
