...
bridge briefly preserves the CredUI-equivalent preflight delay before stopping MSTSC's proprietary
continuation, leaving the native shell available for ActiveX RPC operations.
