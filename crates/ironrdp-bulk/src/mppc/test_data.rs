//! Test vectors ported from FreeRDP's `TestFreeRDPCodecMppc.c`.

/// Expected decompressed text: "for.whom.the.bell.tolls,.the.bell.tolls.for.thee!"
pub(super) const TEST_MPPC_BELLS: &[u8] = b"for.whom.the.bell.tolls,.the.bell.tolls.for.thee!";

/// RDP4 (MPPC 8K) compressed form of TEST_MPPC_BELLS. Flags: 0x0060, Length: 33
#[rustfmt::skip]
pub(super) const TEST_MPPC_BELLS_RDP4: &[u8] = &[
    0x66, 0x6f, 0x72, 0x2e, 0x77, 0x68, 0x6f, 0x6d, 0x2e, 0x74, 0x68, 0x65, 0x2e, 0x62, 0x65, 0x6c,
    0x6c, 0x2e, 0x74, 0x6f, 0x6c, 0x6c, 0x73, 0x2c, 0xf4, 0x37, 0x2e, 0x66, 0xfa, 0x1f, 0x19, 0x94,
    0x84,
];

/// RDP5 (MPPC 64K) compressed form of TEST_MPPC_BELLS. Flags: 0x0061, Length: 34
#[rustfmt::skip]
pub(super) const TEST_MPPC_BELLS_RDP5: &[u8] = &[
    0x66, 0x6f, 0x72, 0x2e, 0x77, 0x68, 0x6f, 0x6d, 0x2e, 0x74, 0x68, 0x65, 0x2e, 0x62, 0x65, 0x6c,
    0x6c, 0x2e, 0x74, 0x6f, 0x6c, 0x6c, 0x73, 0x2c, 0xfa, 0x1b, 0x97, 0x33, 0x7e, 0x87, 0xe3, 0x32,
    0x90, 0x80,
];

/// Large RDP5 compressed data test vector from FreeRDP (2835 bytes).
#[rustfmt::skip]
pub(super) const TEST_RDP5_COMPRESSED_DATA: &[u8] = &[
...
/// Large RDP5 uncompressed data (6496 bytes) — expected output for TEST_RDP5_COMPRESSED_DATA.
#[rustfmt::skip]
pub(super) const TEST_RDP5_UNCOMPRESSED_DATA: &[u8] = &[
...
/// John Donne's "No Man Is an Island" excerpt used for compression test.
///
...
/// RDP5 (MPPC 64K) compressed form of TEST_ISLAND_DATA. 297 bytes.
#[rustfmt::skip]
pub(super) const TEST_ISLAND_DATA_RDP5: &[u8] = &[
    ,
];
