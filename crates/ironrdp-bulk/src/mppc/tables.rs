...
//!
//! Ported from FreeRDP's `libfreerdp/codec/mppc.c`.
...
///
/// This is the Rust equivalent of FreeRDP's `MPPC_MATCH_INDEX` macro:
/// ```c
...
///
/// Ported byte-for-byte from FreeRDP's `MPPC_MATCH_TABLE[256]`.
#[rustfmt::skip]
