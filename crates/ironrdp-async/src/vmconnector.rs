...
use ironrdp_vmconnect::{VmClientConnector, VmConnectorState};
...
pub fn take_over(_: PcbSent, connector: ClientConnector) -> ConnectorResult<VmClientConnector> {
...
pub async fn run_until_handover(
    ...
    let result = loop {
        ...
        if let VmConnectorState::Handover = connector.state {
