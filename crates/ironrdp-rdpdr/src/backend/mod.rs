...
use crate::Rdpdr;
use crate::pdu::efs::{DeviceControlRequest, Devices, ServerDeviceAnnounceResponse, ServerDriveIoRequest};
...
pub trait RdpdrBackend: AsAny + fmt::Debug + Send {
    ...
    fn handle_user_logged_on(&mut self, device_list: &mut Devices) -> PduResult<Vec<SvcMessage>>;
}
