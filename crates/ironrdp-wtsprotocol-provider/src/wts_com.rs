...
use windows::Win32::Foundation::{
    ...
    ERROR_SUCCESS, HANDLE, HANDLE_PTR, HLOCAL, LocalFree,
};
...
use windows::Win32::System::RemoteDesktop::{
    ...
    IWRdsProtocolListenerCallback, IWRdsProtocolLogonErrorRedirector, IWRdsProtocolManager,
    ...
    WRDS_CONNECTION_SETTINGS_1, WRDS_LISTENER_SETTING, WRDS_LISTENER_SETTING_LEVEL, WRDS_LISTENER_SETTINGS,
    ...
    WTS_LICENSE_PREAMBLE_VERSION, WTS_PROPERTY_VALUE, WTS_PROTOCOL_STATUS, WTS_SERVICE_STATE, WTS_SESSION_ID,
    WTS_SESSION_INFOW, WTS_USER_CREDENTIAL, WTSDisconnected,
    WTSEnumerateSessionsW, WTSFreeMemory, WTSGetListenerSecurityW, WTSVirtualChannelClose, WTSVirtualChannelOpenEx,
...
impl IWRdsProtocolConnection_Impl for ComProtocolConnection_Impl {
    ...
    fn NotifySessionId(
        ...
        if let Err(error) = self
            .control_bridge
            .set_capture_session_id_retried(self.inner.connection_id(), wts_session_id)
        {
    ...
    fn ConnectNotify(&self, sessionid: u32) -> windows_core::Result<()> {
        ...
        match self
            .control_bridge
            .set_capture_session_id_retried(connection_id, sessionid)
        {
            Ok(()) => {
                debug_log_line(&format!(
