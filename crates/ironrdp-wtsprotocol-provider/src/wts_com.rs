...
use windows::Win32::Foundation::{
    ...
    ERROR_BROKEN_PIPE, ERROR_IO_INCOMPLETE, ERROR_NO_DATA, ERROR_SEM_TIMEOUT, ERROR_SUCCESS, HANDLE, HANDLE_PTR,
};
use windows::Win32::Security::Authorization::{ConvertStringSecurityDescriptorToSecurityDescriptorW, SDDL_REVISION_1};
use windows::Win32::Security::{
    DACL_SECURITY_INFORMATION, GROUP_SECURITY_INFORMATION, GetKernelObjectSecurity, IsValidSecurityDescriptor,
    OWNER_SECURITY_INFORMATION, PSECURITY_DESCRIPTOR, SACL_SECURITY_INFORMATION,
};
use windows::Win32::System::Com::{
    COINIT_MULTITHREADED, CoInitializeEx, CoUninitialize, IAgileObject, IClassFactory, IClassFactory_Impl,
};
...
use windows::Win32::System::RemoteDesktop::{
    ...
    IWRdsProtocolListener, IWRdsProtocolListener_Impl, IWRdsProtocolListenerCallback,
    IWRdsProtocolLogonErrorRedirector, IWRdsProtocolManager, IWRdsProtocolManager_Impl, IWRdsProtocolSettings,
    IWRdsProtocolShadowConnection, IWRdsWddmIddProps, IWRdsWddmIddProps_Impl, WRDS_CONNECTION_SETTING,
    WRDS_CONNECTION_SETTING_LEVEL, WRDS_CONNECTION_SETTINGS, WRDS_CONNECTION_SETTINGS_1, WRDS_LISTENER_SETTING,
    WRDS_LISTENER_SETTING_LEVEL, WRDS_LISTENER_SETTINGS, WRDS_LISTENER_SETTINGS_1, WRDS_SETTINGS,
    ...
    WTS_PROTOCOL_STATUS, WTS_PROTOCOL_TYPE_RDP, WTS_SERVICE_STATE, WTS_SESSION_ID, WTS_USER_CREDENTIAL,
    WTSGetListenerSecurityW, WTSVirtualChannelClose, WTSVirtualChannelOpenEx, WTSVirtualChannelRead,
    WTSVirtualChannelWrite,
};
use windows::Win32::System::Threading::GetCurrentProcess;
use windows_core::{BOOL, GUID, Interface as _, PCSTR, PCWSTR, implement};
...
impl ProviderControlBridge {
    ...
    fn send_command_with_retries(
        ...
        let error =
            last_error.unwrap_or_else(|| std::io::Error::new(std::io::ErrorKind::Other, "max retries exceeded"));
