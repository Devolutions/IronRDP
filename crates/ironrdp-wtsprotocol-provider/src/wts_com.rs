...
use windows::Win32::System::RemoteDesktop::{
    ...
    WTS_LICENSE_PREAMBLE_VERSION, WTS_PROPERTY_VALUE, WTS_PROTOCOL_STATUS, WTS_PROTOCOL_TYPE_RDP,
    WTS_SERVICE_STATE, WTS_SESSION_ID, WTS_SESSION_INFOW, WTS_USER_CREDENTIAL, WTSDisconnected,
