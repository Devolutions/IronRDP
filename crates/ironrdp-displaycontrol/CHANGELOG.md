...
## [[0.6.0](https://github.com/Devolutions/IronRDP/compare/ironrdp-displaycontrol-v0.5.0...ironrdp-displaycontrol-v0.6.0)] - 2026-05-19
### <!-- 7 -->Build

- [**breaking**] Update public dependencies (ironrdp-pdu 0.8, ironrdp-svc 0.7, ironrdp-dvc 0.6; breaking changes propagated via public API)
