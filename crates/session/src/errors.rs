...
use ironrdp_pdu::dvc::{display, gfx};
use ironrdp_pdu::fast_path::FastPathError;
use ironrdp_pdu::rdp::server_license::ServerLicenseError;
use ironrdp_pdu::{codecs, rdp, McsError};
use thiserror::Error;
...
pub enum RdpError {
    ...
    Negotiation(#[from] ironrdp_pdu::NegotiationError),
    ...
    UnexpectedFastPathUpdate(ironrdp_pdu::fast_path::UpdateCode),
