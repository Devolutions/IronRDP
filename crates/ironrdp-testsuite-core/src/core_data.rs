...
pub static CLIENT_CORE_DATA_WITHOUT_OPTIONAL_FIELDS: LazyLock<ClientCoreData> = LazyLock::new(|| ClientCoreData {
...
pub static CLIENT_OPTIONAL_CORE_DATA_TO_HIGH_COLOR_DEPTH: LazyLock<ClientCoreData> = LazyLock::new(|| {
...
pub static CLIENT_OPTIONAL_CORE_DATA_TO_SERVER_SELECTED_PROTOCOL: LazyLock<ClientCoreData> = LazyLock::new(|| {
...
pub static CLIENT_CORE_DATA_WITH_ALL_OPTIONAL_FIELDS: LazyLock<ClientCoreData> = LazyLock::new(|| {
...
pub static CLIENT_CORE_DATA_WITH_ALL_OPTIONAL_FIELDS_WITH_WANT_32_BPP_EARLY_FLAG: LazyLock<ClientCoreData> =
    LazyLock::new(|| {
...
pub static CLIENT_CORE_DATA_WITH_ALL_OPTIONAL_FIELDS_WITH_WANT_32_BPP_EARLY_FLAG_BUFFER: LazyLock<Vec<u8>> =
    LazyLock::new(|| {
...
pub static SERVER_CORE_DATA: LazyLock<ServerCoreData> = LazyLock::new(|| ServerCoreData {
    version: RdpVersion::V5_PLUS,
...
pub static SERVER_CORE_DATA_TO_FLAGS: LazyLock<ServerCoreData> = LazyLock::new(|| ServerCoreData {
    version: RdpVersion::V5_PLUS,
    optional_data: ServerCoreOptionalData {
...
pub static SERVER_CORE_DATA_WITH_ALL_OPTIONAL_FIELDS: LazyLock<ServerCoreData> = LazyLock::new(|| ServerCoreData {
    version: RdpVersion::V5_PLUS,
    optional_data: ServerCoreOptionalData {
        client_requested_protocols: Some(SecurityProtocol::empty()),
