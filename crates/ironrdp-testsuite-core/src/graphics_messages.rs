...
/// LC set to CHROMA with cbAvc420EncodedBitstream1 zero, as MS-RDPEGFX 2.2.4.5 requires.
pub const AVC_444_CHROMA_MESSAGE: [u8; 88] = [
...
/// The same stream with the first sub-stream length filled in, as some servers send it.
pub const AVC_444_CHROMA_MESSAGE_WITH_LEN: [u8; 88] = [
...
pub static WIRE_TO_SURFACE_1: LazyLock<WireToSurface1Pdu> = LazyLock::new(|| WireToSurface1Pdu {
    surface_id: 0,
...
pub static WIRE_TO_SURFACE_1_BITMAP_DATA: LazyLock<Vec<u8>> = LazyLock::new(|| WIRE_TO_SURFACE_1_BUFFER[17..].to_vec());
pub static WIRE_TO_SURFACE_2: LazyLock<WireToSurface2Pdu> = LazyLock::new(|| WireToSurface2Pdu {
    surface_id: 0,
...
pub static WIRE_TO_SURFACE_2_BITMAP_DATA: LazyLock<Vec<u8>> = LazyLock::new(|| WIRE_TO_SURFACE_2_BUFFER[13..].to_vec());
pub static DELETE_ENCODING_CONTEXT: LazyLock<DeleteEncodingContextPdu> = LazyLock::new(|| DeleteEncodingContextPdu {
    surface_id: 0,
    codec_context_id: 1,
});
pub static SOLID_FILL: LazyLock<SolidFillPdu> = LazyLock::new(|| SolidFillPdu {
    surface_id: 0,
    fill_pixel: Color {
        b: 0,
        g: 0,
...
pub static SURFACE_TO_CACHE: LazyLock<SurfaceToCachePdu> = LazyLock::new(|| SurfaceToCachePdu {
    surface_id: 0,
...
pub static CACHE_TO_SURFACE: LazyLock<CacheToSurfacePdu> = LazyLock::new(|| CacheToSurfacePdu {
    cache_slot: 2,
    surface_id: 0,
    destination_points: vec![Point { x: 768, y: 320 }],
});
pub static CREATE_SURFACE: LazyLock<CreateSurfacePdu> = LazyLock::new(|| CreateSurfacePdu {
    surface_id: 0,
    width: 1024,
    height: 768,
    pixel_format: PixelFormat::ARgb,
});
pub static DELETE_SURFACE: LazyLock<DeleteSurfacePdu> = LazyLock::new(|| DeleteSurfacePdu { surface_id: 0 });
pub static RESET_GRAPHICS: LazyLock<ResetGraphicsPdu> = LazyLock::new(|| ResetGraphicsPdu {
    width: 1024,
    height: 768,
...
pub static MAP_SURFACE_TO_OUTPUT: LazyLock<MapSurfaceToOutputPdu> = LazyLock::new(|| MapSurfaceToOutputPdu {
    surface_id: 0,
    output_origin_x: 1,
    output_origin_y: 2,
});
pub static EVICT_CACHE_ENTRY: LazyLock<EvictCacheEntryPdu> = LazyLock::new(|| EvictCacheEntryPdu { cache_slot: 0 });
pub static START_FRAME: LazyLock<StartFramePdu> = LazyLock::new(|| StartFramePdu {
    timestamp: Timestamp {
        milliseconds: 247,
        seconds: 58,
        minutes: 27,
...
pub static FRAME_ACKNOWLEDGE: LazyLock<FrameAcknowledgePdu> = LazyLock::new(|| FrameAcknowledgePdu {
    queue_depth: QueueDepth::Unavailable,
    frame_id: 1,
    total_frames_decoded: 1,
});
pub static CACHE_IMPORT_REPLY: LazyLock<CacheImportReplyPdu> = LazyLock::new(|| CacheImportReplyPdu {
    cache_slots: vec![
        0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xa, 0xb, 0xc, 0xd, 0xe, 0xf, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16,
        ...
        0xa7, 0xa8, 0xa9, 0xaa, 0xab, 0xac, 0xad, 0xae, 0xaf, 0xb0, 0xb1, 0xb2, 0xb3, 0xb4, 0xb5, 0xb6, 0xb7, 0xb8,
...
pub static AVC_444_BITMAP: LazyLock<Avc444BitmapStream<'static>> = LazyLock::new(|| Avc444BitmapStream {
    ...
    stream1: Avc420BitmapStream {
        ...
        data: &AVC_444_CHROMA_MESSAGE[18..],
    },
    stream2: None,
});
