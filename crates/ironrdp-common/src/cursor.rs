...
macro_rules! cursor_helper_ensure_size {
...
impl<'a> ReadCursor<'a> {
    ...
    pub fn try_read_u8(&mut self) -> Result<u8, NotEnoughBytesError> {
        cursor_helper_ensure_size!(in: self, size: 1);
        Ok(self.read_u8())
    }
    ...
    pub fn try_read_u16(&mut self) -> Result<u16, NotEnoughBytesError> {
        cursor_helper_ensure_size!(in: self, size: 2);
        Ok(self.read_u16())
    }
    ...
    pub fn try_read_u32(&mut self) -> Result<u32, NotEnoughBytesError> {
        cursor_helper_ensure_size!(in: self, size: 4);
        Ok(self.read_u32())
    }
    ...
    pub fn try_read_u64(&mut self) -> Result<u64, NotEnoughBytesError> {
        cursor_helper_ensure_size!(in: self, size: 8);
        Ok(self.read_u64())
    }
    ...
    pub fn peek_i16(&mut self) -> i16 {
        i16::from_le_bytes(self.peek::<2>())
    }

    #[inline]
    #[track_caller]
    pub fn peek_i16_be(&mut self) -> i16 {
        i16::from_be_bytes(self.peek::<2>())
    }

    #[inline]
    pub fn try_peek_i16(&mut self) -> Result<i16, NotEnoughBytesError> {
        cursor_helper_ensure_size!(in: self, size: 2);
        Ok(self.peek_i16())
    }

    #[inline]
    pub fn try_peek_i16_be(&mut self) -> Result<i16, NotEnoughBytesError> {
        cursor_helper_ensure_size!(in: self, size: 2);
        Ok(self.peek_i16_be())
    }
    ...
    pub fn peek_i32(&mut self) -> i32 {
        i32::from_le_bytes(self.peek::<4>())
    }

    #[inline]
    #[track_caller]
    pub fn peek_i32_be(&mut self) -> i32 {
        i32::from_be_bytes(self.peek::<4>())
    }

    #[inline]
    pub fn try_peek_i32(&mut self) -> Result<i32, NotEnoughBytesError> {
        cursor_helper_ensure_size!(in: self, size: 4);
        Ok(self.peek_i32())
    }

    #[inline]
    pub fn try_peek_i32_be(&mut self) -> Result<i32, NotEnoughBytesError> {
        cursor_helper_ensure_size!(in: self, size: 4);
        Ok(self.peek_i32_be())
    }
    ...
    pub fn peek_i64(&mut self) -> i64 {
        i64::from_le_bytes(self.peek::<8>())
    }

    #[inline]
    #[track_caller]
    pub fn peek_i64_be(&mut self) -> i64 {
        i64::from_be_bytes(self.peek::<8>())
    }

    #[inline]
    pub fn try_peek_i64(&mut self) -> Result<i64, NotEnoughBytesError> {
        cursor_helper_ensure_size!(in: self, size: 8);
        Ok(self.peek_i64())
    }

    #[inline]
    pub fn try_peek_i64_be(&mut self) -> Result<i64, NotEnoughBytesError> {
        cursor_helper_ensure_size!(in: self, size: 8);
        Ok(self.peek_i64_be())
    }
