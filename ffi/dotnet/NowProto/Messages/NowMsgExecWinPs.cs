...
namespace NowProto.Messages
{
    ...
    /// </summary>
    public class NowMsgExecWinPs(uint sessionId, string command) : INowSerialize
    {
        // -- INowMessage --

        public static byte TypeMessageClass => NowMessage.ClassExec;
        public static byte TypeMessageKind => 0x15; // NOW-PROTO: NOW_EXEC_WIN_PS_MSG_ID

        public byte MessageClass => NowMessage.ClassExec;
        public byte MessageKind => 0x15;
