...
internal partial struct ConnectionActivationSequence
{
    ...
    [DllImport(DiplomatNativeLib.Name, EntryPoint = "ConnectionActivationSequence_get_io_channel_id", CallingConvention = CallingConvention.Cdecl)]
    internal static unsafe extern ushort GetIoChannelId(ConnectionActivationSequence* handle);

    [DllImport(DiplomatNativeLib.Name, EntryPoint = "ConnectionActivationSequence_get_user_channel_id", CallingConvention = CallingConvention.Cdecl)]
    internal static unsafe extern ushort GetUserChannelId(ConnectionActivationSequence* handle);
