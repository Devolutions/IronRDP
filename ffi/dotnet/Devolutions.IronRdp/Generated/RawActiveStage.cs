...
internal partial struct ActiveStage
{
    ...
    [DllImport(DiplomatNativeLib.Name, EntryPoint = "ActiveStage_create_connection_activation", CallingConvention = CallingConvention.Cdecl)]
    internal static unsafe extern ConnectionActivationSequence* CreateConnectionActivation(ActiveStage* handle);
