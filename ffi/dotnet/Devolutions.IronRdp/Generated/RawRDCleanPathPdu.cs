...
internal partial struct RDCleanPathPdu
{
    ...
    internal static unsafe extern void GetServerAddr(RDCleanPathPdu* handle, DiplomatWrite* writeable);

    [DllImport(DiplomatNativeLib.Name, EntryPoint = "RDCleanPathPdu_get_error_message", CallingConvention = CallingConvention.Cdecl)]
    internal static unsafe extern void GetErrorMessage(RDCleanPathPdu* handle, DiplomatWrite* writeable);
